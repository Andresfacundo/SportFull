  ...
  return (
    <div style={backgroundStyle} className='container'>
     ...
     <main className='main_homeEmpresa'>
        ...
        <OptionMenuLeft link={''} shade={'shade_ManageFields'} classNameImg={'icon_2'} icon={icon_02} content={'Gestión Canchas'} />
        <OptionMenuRight link={''} shade={'shade_ManageReservations'} classNameImg={'icon_3'} icon={icon_03} content={'Gestión Reservas'} />
        <OptionMenuLeft link={''} shade={'shade_ManageEmployees'} classNameImg={'icon_4'} icon={icon_04} content={'Gestión Empleados'} />
        <OptionMenuRight link={''} shade={'shade_ManageReports'} classNameImg={'icon_3'} icon={icon_01} content={'Gestión Reportes'} />
